...
import com.octospoon.octospoon.core.lifecycle.DecisionEngine;
import com.octospoon.octospoon.core.nlp.SentimentAnalyzer;
...
public class Agent {
    ...
    public void provideAnswer(Message message) {
        ...
        if (decisionEngine.isInitialMessage(message.text())) {
            answer = KnowledgeBase.HELLO_MESSAGE;
        }
        answer = answer + "\t" + "Your mood is: " + sentimentAnalyzer.sentimentAnalyzer(message.text());
